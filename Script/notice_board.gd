...
#这俩onready相当于get_node. 作用是获取子节点，注意别重名
#get_node("Label")
#get_node("Area2D")
...
func _ready():
	area.body_entered.connect(_on_notice_board_area_2d_body_entered)
	area.body_exited.connect(_on_notice_board_area_2d_body_exited)
